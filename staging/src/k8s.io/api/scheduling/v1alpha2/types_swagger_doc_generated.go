...
var map_BasicGroupSchedulingPolicy = map[string]string{
	"": "BasicGroupSchedulingPolicy indicates that standard Kubernetes scheduling behavior should be used.",
}
...
var map_GangGroupSchedulingPolicy = map[string]string{
	"":             "GangGroupSchedulingPolicy indicates that the pods in this group should be scheduled using all-or-nothing semantics.",
	"minGroupSize": "MinGroupSize is the minimum number of pods of the group that must be available to schedule the group.",
}
