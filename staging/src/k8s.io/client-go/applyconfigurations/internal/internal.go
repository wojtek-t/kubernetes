    ...
    elementType:
      ...
      map:
        elementType:
          namedType: __untyped_deduced_
        elementRelationship: separable
- name: io.k8s.api.scheduling.v1alpha2.GangMultiPodGroupSchedulingPolicy
  map:
    elementType:
      scalar: untyped
      list:
...
- name: io.k8s.api.scheduling.v1alpha2.PodGroupSchedulingPolicy
  map:
    ...
    - name: gangMultiPodGroup
      type:
        namedType: io.k8s.api.scheduling.v1alpha2.GangMultiPodGroupSchedulingPolicy
    unions:
    - fields:
      - fieldName: basic
      ...
      - fieldName: gangMultiPodGroup
        discriminatorValue: GangMultiPodGroup
...
- name: io.k8s.api.scheduling.v1beta1.PodGroupSpec
  map:
    ...
    - name: podGroupTemplateRef
      type:
        namedType: io.k8s.api.scheduling.v1beta1.PodGroupTemplateReference
    - name: priority
      type:
        scalar: numeric
    - name: priorityClassName
  ...
  map:
    ...
    - name: schedulingPolicy
      type:
        namedType: io.k8s.api.scheduling.v1beta1.PodGroupSchedulingPolicy
      default: {}
- name: io.k8s.api.scheduling.v1beta1.PodGroupTemplateReference
  map:
    fields:
    - name: workload
      type:
        namedType: io.k8s.api.scheduling.v1beta1.WorkloadPodGroupTemplateReference
    unions:
    - fields:
      - fieldName: workload
        discriminatorValue: Workload
...
- name: io.k8s.api.scheduling.v1beta1.Workload
  map:
    ...
    - name: spec
      ...
      default: {}
- name: io.k8s.api.scheduling.v1beta1.WorkloadPodGroupTemplateReference
  map:
    fields:
    - name: podGroupTemplateName
      type:
