...
type Interface interface {
	// MultiPodGroups returns a MultiPodGroupInformer.
	MultiPodGroups() MultiPodGroupInformer
...
// MultiPodGroups returns a MultiPodGroupInformer.
func (v *version) MultiPodGroups() MultiPodGroupInformer {
	return &multiPodGroupInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
