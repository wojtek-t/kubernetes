...
MASTER_OS_DISTRIBUTION="ubuntu" #${KUBE_MASTER_OS_DISTRIBUTION:-${KUBE_OS_DISTRIBUTION:-gci}}
...
MASTER_IMAGE="ubuntu-gke-1804-d1809-0-v20190813a" #${KUBE_GCE_MASTER_IMAGE:-}
MASTER_IMAGE_PROJECT="ubuntu-os-gke-cloud" #${KUBE_GCE_MASTER_PROJECT:-cos-cloud}
