...
func (mp *fakePodGroupPlugin) PodGroupPostFilter(ctx context.Context, pg *schedulingv1beta1.PodGroup, pods []*v1.Pod, pgSchedulingFunc func(ctx context.Context) *fwk.Status) *fwk.Status {
...
func TestPodGroupCycle_UpdateSnapshotError(t *testing.T) {
	...
	podGroupLister := informerFactory.Scheduling().V1beta1().PodGroups().Lister()
