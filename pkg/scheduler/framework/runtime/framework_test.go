...
func (pl *TestPlugin) PodGroupPostFilter(ctx context.Context, pg *v1beta1.PodGroup, pods []*v1.Pod, pgSchedulingFunc func(ctx context.Context) *fwk.Status) *fwk.Status {
	return nil
}
